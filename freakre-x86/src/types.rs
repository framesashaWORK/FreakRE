...
pub enum Mnemonic {
    ...
    // Arithmetic
    Add, Sub, Inc, Dec, Mul, Imul, Div, Idiv, Neg, Adc, Sbb,
    // Logic
    And, Or, Xor, Not, Shl, Shr, Sar, Sal, Rol, Ror, Bsf, Bsr, Bt, Bts, Btr, Btc,
    // Compare & test
    Cmp, Test,
    // Control flow
    Jmp, Jcc, Call, Ret, Int, Syscall, Nop, Hlt, Ud2,
    // Flags
    Setcc, Lahf, Sahf, Pushfd, Popfd, Pushfq, Popfq_, Stc, Clc, Cmc, Std, Cld, Sti, Cli,
    // String ops
    Movsb, Movsw, Movsd, Movsq, Stosb, Stosw, Stosd, Stosq,
    Lodsb, Lodsw, Lodsd, Lodsq, Scasb, Scasw, Scasd, Scasq,
    Cmpsb, Cmpsw, Cmpsd, Cmpsq, Rep, Repne,
    // Stack frame
    Enter, Leave,
    // Misc
    Cdq, Cwd, Cbw, Cwde, Cdqe, Bswap, Xlat, Cpuid, Rdtsc,
    // Conditional
    Cmova, Cmovae, Cmovb, Cmovbe, Cmove, Cmovg, Cmovge, Cmovl, Cmovle,
    Cmovna, Cmovnae, Cmovnb, Cmovnbe, Cmovne, Cmovng, Cmovnge, Cmovnl, Cmovnle,
...
impl Mnemonic {
    ...
    pub fn as_str(&self) -> String {
        let s: &'static str = match self {
            ...
            Self::Add => "add", Self::Sub => "sub", Self::Inc => "inc", Self::Dec => "dec",
            Self::Mul => "mul", Self::Imul => "imul", Self::Div => "div", Self::Idiv => "idiv",
            Self::Neg => "neg", Self::Adc => "adc", Self::Sbb => "sbb",
            Self::And => "and", Self::Or => "or", Self::Xor => "xor", Self::Not => "not",
            Self::Shl => "shl", Self::Shr => "shr", Self::Sar => "sar", Self::Sal => "sal",
            ...
            Self::Jmp => "jmp", Self::Call => "call", Self::Ret => "ret",
            Self::Int => "int", Self::Syscall => "syscall", Self::Nop => "nop",
            Self::Hlt => "hlt", Self::Ud2 => "ud2",
            Self::Setcc => "setcc", Self::Lahf => "lahf", Self::Sahf => "sahf",
            Self::Stc => "stc", Self::Clc => "clc", Self::Cmc => "cmc",
            Self::Std => "std", Self::Cld => "cld", Self::Sti => "sti", Self::Cli => "cli",
            Self::Movsb => "movsb", Self::Movsw => "movsw", Self::Movsd => "movsd", Self::Movsq => "movsq",
            Self::Stosb => "stosb", Self::Stosw => "stosw", Self::Stosd => "stosd", Self::Stosq => "stosq",
            Self::Lodsb => "lodsb", Self::Lodsw => "lodsw", Self::Lodsd => "lodsd", Self::Lodsq => "lodsq",
            Self::Enter => "enter", Self::Leave => "leave",
            Self::Cdq => "cdq", Self::Cwd => "cwd", Self::Cbw => "cbw",
            Self::Cwde => "cwde", Self::Cdqe => "cdqe", Self::Bswap => "bswap",
            Self::Xlat => "xlat", Self::Cpuid => "cpuid", Self::Rdtsc => "rdtsc",
            Self::Ja => "ja", Self::Jae => "jae", Self::Jb => "jb", Self::Jbe => "jbe",
            Self::Je => "je", Self::Jg => "jg", Self::Jge => "jge",
            Self::Jl => "jl", Self::Jle => "jle", Self::Jna => "jna", Self::Jnae => "jnae",
            Self::Jnb => "jnb", Self::Jnbe => "jnbe", Self::Jne => "jne",
            Self::Jng => "jng", Self::Jnge => "jnge", Self::Jnl => "jnl", Self::Jnle => "jnle",
            Self::Jno => "jno", Self::Jnp => "jnp", Self::Jns => "jns", Self::Jnz => "jnz",
            Self::Jo => "jo", Self::Jp => "jp", Self::Js => "js", Self::Jz => "jz",
            Self::Cmova => "cmova", Self::Cmovae => "cmovae", Self::Cmovb => "cmovb",
            Self::Cmovbe => "cmovbe", Self::Cmove => "cmove", Self::Cmovg => "cmovg",
            Self::Cmovge => "cmovge", Self::Cmovl => "cmovl", Self::Cmovle => "cmovle",
            Self::Cmovna => "cmovna", Self::Cmovnae => "cmovnae", Self::Cmovnb => "cmovnb",
            Self::Cmovnbe => "cmovnbe", Self::Cmovne => "cmovne", Self::Cmovng => "cmovng",
            Self::Cmovnge => "cmovnge", Self::Cmovnl => "cmovnl", Self::Cmovnle => "cmovnle",
            Self::Cmovno => "cmovno", Self::Cmovnp => "cmovnp", Self::Cmovns => "cmovns",
            Self::Cmovnz => "cmovnz", Self::Cmovo => "cmovo", Self::Cmovp => "cmovp",
            Self::Cmovpe => "cmovpe", Self::Cmovpo => "cmovpo", Self::Cmovs => "cmovs",
            Self::Cmovz => "cmovz",
            Self::Rep => "rep", Self::Repne => "repne",
            Self::Pushfd => "pushfd", Self::Popfd => "popfd",
            Self::Pushfq => "pushfq", Self::Popfq_ => "popfq",
